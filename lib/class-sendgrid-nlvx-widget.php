...
class SendGrid_NLVX_Widget extends WP_Widget {
    ...
    private function display_form() {
      ...
      echo '  </div>';
      echo '  <div class="sendgrid_mc_input_div">';
      echo '    <input placeholder="Your email here" class="sendgrid_mc_input sendgrid_mc_input_email" id="sendgrid_mc_email" name="sendgrid_mc_email" type="text" value="" required/>';
      echo '  </div>';
      echo '</div>';
